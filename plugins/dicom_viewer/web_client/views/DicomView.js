...
const DicomSliceImageWidget = View.extend({
    ...
    render: function () {
        ...
        this.vtk.iteractor = vtkRenderWindowInteractor.newInstance();
        const style = vtkInteractorStyleImage.newInstance();
        this.vtk.iteractor.setInteractorStyle(style);
        this.vtk.iteractor.setView(glWin);
        ...
        this.vtk.iteractor.initialize();
        this.vtk.iteractor.bindEvents(this.el);
        this.vtk.iteractor.start();

        this.autoLevels(false);
        this.autoZoom(false);
        this.vtk.iteractor.render();
